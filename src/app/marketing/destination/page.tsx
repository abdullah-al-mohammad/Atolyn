...
export const Destination = () => {
  ...
  const textData = [
    ...
    },
    {
      ...
      description:
        "Details about the second item go here.Details about the second item go here.",
    },
    {
    ...
    },
    {
      title: "visual design",
      description:
        "More info about the fourth text element.Details about the second item go here.",
    },
    {
  ...
  return (
    <div className="container min-h-screen">
      <div className="overflow-hidden" ref={containerRef}>
        <h5 className="mb-5 font-bold text-rose-400 text-2xl">
          ✔ we worked on
        </h5>
        <div className="flex gap-20">
          <div className="w-1/2 sticky top-20 self-start transition-all duration-300">
